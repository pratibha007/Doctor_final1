            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h1> Available Doctors
                        <a href="adddoc.php"><button class="btn btn-primary"> Add Doctor</button></a> 
                    </h1>
                    ...
                    while ($data = mysqli_fetch_assoc($res)) {
                        ...
                        <td><?= $data['date'] ?></td>
                        <td>
                            <a href="editpage.php?id=<?= $data['id']  ?>"><button class="btn btn-default">Edit</button></a>
                            <a href="action/act_deletepage.php?id=<?= $data['id']  ?>"><button class="btn btn-danger">Delete</button></a>
                        </td>
                         </tr>
                        <?php
                        $count++;
