...
$query = "select * from info where duty_hour='night' ";
    ...
    <body>
        ...
        <div class="container">
         ...
         <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1> Night Shift Doctors</h1><br><br>
                    <div class="gallery">
                            <a target="_blank" href="DSC_0023.JPG">
                                <img src="../images/doc1_evening.png" alt="" width="300" height="200"/>
                            </a>
                        <div class="desc">Dr.Roshan<br>MBBS(TUTH) MD(KMC)</div>
                        ...
                        <div class="gallery">
                            <a target="_blank" href="forest.jpg">
                                <img src="../images/doc2_evening.jpg" alt="" width="300" height="200"/>
                            </a>
                            <div class="desc">Dr.Sirjana<br>MBBS(TUTH) MD(KMC)</div>
                            <a href="sendmsg.php"><button class="btn btn-danger">Contact</button></a>
                        </div>
                </div>
            </div>
